...
public class pestInitialAdapter extends RecyclerView.Adapter<pestInitialAdapter.MyViewHolder> {
    ...
    public pestInitialAdapter(ArrayList<currentCrop> data) {
        this.crops = data;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        view.setOnClickListener(pestInitial.myOnClickListener);
